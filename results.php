<?php
    ...
    // Initialize or retrieve coordinates from session
    ...
    // Get place IDs and their details from the database
    ...
    // Merge DB results with combinedResults
    ...
    $stmt = $con->prepare("SELECT AVG(score) FROM reviews WHERE place_id = ?");
...
<head>
    ...
    <link href='css/pottystyles.css?v=4' rel='stylesheet' />
</head>
<body>
